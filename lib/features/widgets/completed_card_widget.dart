...
import '../../core/helper/theme/app_theme_provider.dart';
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Divider(color: placeHolderColor,),
              const SizedBox(height: 10,),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(onPressed: (){
                      push(context: context, screen: WriteReview());
                        ...
                        child:  Text('Review.leave-rev'.tr(),style: AppTextStyle(size: 12, fontweight: FontWeight.w600,color:Colors.white ),)),
                  ),
                ],
              ),
            ],
