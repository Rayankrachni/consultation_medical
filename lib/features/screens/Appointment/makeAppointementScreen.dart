...
class _MakeAppointmentScreenState extends State<MakeAppointmentScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(actions:[IconButton(onPressed: (){}, icon: Icon(Icons.favorite,color: Colors.red,size: 30,)),],),
                                              ...
                                              child: Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      "${index + 9}:00 am",
                                                      style:AppTextStyle(size: 11, fontweight: FontWeight.w600,color:index!=2? Theme.of(context).colorScheme.secondary:Colors.white),
                                                    ),
                                      ...
                                      children: [
                                        ...
                                        SizedBox(
                                            ...
                                            child: ElevatedButton(
                                                ...
                                                }, child: Text('Button.make-appointment'.tr(),style: AppTextStyle(size: 14, fontweight: FontWeight.normal,color: Colors.white),)))
